import { TOWN_HALL_LEVELS_FOR_ROLES } from '../../util/constants.js';
...
export default class AutoTownHallRoleCommand extends Command {
    ...
    async exec(interaction, args) {
        ...
        for (const key in args) {
            if (!TOWN_HALL_KEYS.includes(key))
                continue;
        ...
        const rolesConfig = this.client.settings.get(interaction.guildId, "townHallRoles" /* Settings.TOWN_HALL_ROLES */, {});
        Object.assign(rolesConfig, Object.fromEntries(selected.map((s) => [s.hall, s.role.id])));
        await this.client.settings.set(interaction.guildId, "townHallRoles" /* Settings.TOWN_HALL_ROLES */, rolesConfig);
...
//# sourceMappingURL=autorole-town-hall.js.map