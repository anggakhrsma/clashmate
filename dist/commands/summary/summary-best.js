import { ActionRowBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder, StringSelectMenuBuilder, embedLength, escapeMarkdown } from 'discord.js';
...
export default class SummaryBestCommand extends Command {
    ...
    async exec(interaction, args) {
        ...
        const aggregated = await this.client.db
            ...
            {
                $lookup: {
                    from: "Players" /* Collections.PLAYERS */,
                    localField: 'tag',
                    foreignField: 'tag',
                    as: '_score',
                    pipeline: [
            ...
            {
                $lookup: {
                    from: "ClanGamesPoints" /* Collections.CLAN_GAMES_POINTS */,
                    localField: 'tag',
                    foreignField: 'tag',
                    as: '_clanGames',
                    pipeline: [
        ...
        for (const field of filtered) {
            ...
            embed.addFields({
                ...
                value: members
                    .map((member, n) => {
                    const num = key === '_clanGamesCompletionTime'
        ...
        const row = new ActionRowBuilder().addComponents(new ButtonBuilder()
            ...
            .setLabel(order === 'desc' ? 'Ascending' : 'Descending'), new ButtonBuilder()
        ...
        const menuRow = new ActionRowBuilder().addComponents(new StringSelectMenuBuilder()
            ...
            .setMinValues(1)
            .setOptions(_fields.map((field) => {
            const labelText = fields[field];
...
//# sourceMappingURL=summary-best.js.map