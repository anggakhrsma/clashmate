...
export default class LineupCommand extends Command {
    ...
    async getComparisonLineup(state, clan, opponent) {
        const linups = await this.rosters(clan.members.sort((a, b) => a.mapPosition - b.mapPosition), opponent.members.sort((a, b) => a.mapPosition - b.mapPosition));
        const embed = new EmbedBuilder();
