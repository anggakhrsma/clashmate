...
export default class RushedCommand extends Command {
    ...
    embed(data, locale) {
        ...
        if (embed.data.fields?.length) {
            ...
            embed.setDescription(this.i18n('command.rushed.no_rushed', {
                lng: locale,
    ...
    totalPercentage(hallLevel, rushed) {
...
//# sourceMappingURL=rushed.js.map