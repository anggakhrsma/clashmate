...
export default class WarHistoryCommand extends Command {
    ...
    async getHistory(interaction, _playerTags) {
    ...
    async getIndividualWars(interaction, players) {
...
//# sourceMappingURL=history-war-attacks.js.map