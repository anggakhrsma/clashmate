import { CLAN_GAMES_MINIMUM_POINTS, FeatureFlags, MAX_TOWN_HALL_LEVEL, missingPermissions } from '../../util/constants.js';
...
export default class RemindersCreateCommand extends Command {
    ...
    async clanWarsReminders(interaction, args) {
        ...
        const maxReminders = Math.max(totalClans * 5, 25);
        if (reminders >= maxReminders && !true) {
            return interaction.editReply(this.i18n('command.reminders.create.max_limit', {
                maxReminders: maxReminders.toString(),
                lng: interaction.locale
            }));
        }
        ...
        const state = {
            ...
            smartSkip: false,
            silent: args.exclude_participant_list ||
                [48 * 60 * 60 * 1000, 24 * 60 * 60 * 1000, 0].includes(dur),
...
//# sourceMappingURL=reminders-create.js.map