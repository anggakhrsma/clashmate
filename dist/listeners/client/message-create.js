...
export default class MessageCreateListener extends Listener {
    ...
    parseWithPrefix(messageContent, prefix) {
    ...
    inhibitor(message) {
        const guilds = this.client.settings.get('global', "guildBans" /* Settings.GUILD_BLACKLIST */, []);
        const users = this.client.settings.get('global', "blacklist" /* Settings.USER_BLACKLIST */, []);
